// July 8 (2 days of working on this problem)
// This is a monument of my work and failure. I tried to solve this as best as I could and lost. I am going to work off of someone else's solution now,
// as I am descending into an edge case nightmare that is so inefficient that this implementation is not worth it anymore. 
// Ryu, whenever you think that you have gained skill, look at this moment and know that there is always another giant that awaits you and that you are never to be cocky or pretentious.
//
...
class Solution {
    public static void main(String[] args){
        ...
        // DEBUG
        //System.out.println("Here is the sorted version: ");
        //int[] sorted = {1, 1, 2, 2, 3, 3, 4, 4, 5, 6, 7, 8};
    ...
    public static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        // Base Case Both lengths are of length one
        ...
        for(int i = 0; i < 2; ++i){
            // Base Case where one of the lists is length 1 and the other is of length 2 so the median cannot be accessed
            if(nums1MedianIndex == 0){
                nums1MedianIndex = -1;
            }
            if(nums2[remainingPartition] > nums1[nums1MedianIndex + 1]){
                if(nums1MedianIndex == -1){
                    nums1MedianIndex = 0;
                }
                ...
                while(true){
                    System.out.println("Here is the value of the partition head at nums2: " + nums2[remainingPartition] + " and nums1: " + nums1[nums1MedianIndex]);
            ...
            int[] holder = nums1;
            // To catch the base case handler above if another case is caused through it 
            if(nums1MedianIndex == -1){
                nums1MedianIndex = 0;
            }
            ...
            System.out.println("Made it to the switch");
        }
